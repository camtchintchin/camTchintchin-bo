          ...
          <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
            ...
            <ul class="menu-nav">
              <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
                <a @click="$router.go()"  href="#" class=" btn-blue  menu-toggle">
                  ...
                  <span class="menu-text ">Rafraichir la page</span>
          ...
          <div class="dropdown">
            ...
            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
              <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-danger">
											<span class="number-pulse">3</span>
...
<!--                    </div>-->
          ...
          <div class="topbar-item">
            <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
              ...
              <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{  loggedInUser.username}}</span>
