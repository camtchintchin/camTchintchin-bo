<template>
  <b-container fluid id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading ">
    <!--begin::Main-->
    <MobileSideBar/>
...
<!--          </div>-->
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
      ...
      <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">Profil Utilisateur
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/>
              ...
              <div class="navi-text">
                <div class="font-weight-bold">Modifier mon profil</div>
              </div>
            </div>
          </a>
          <!--end:Item-->
