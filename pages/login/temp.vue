    ...
    <div class="col-xl-4" data-aos="fade-left">
      <div class="row pt-5">
        <div class="col mb-4 mb-lg-0">
          <a class="card card-number  pt-5 py-lg-5  rounded  align-items-center" href="#">
            ...
            <span class="nav-text font-size-lg pb-2  text-center">Utilisateurs<br/>enregistrés</span>
          </a>
        </div>
        <div class="col mb-4 mb-lg-0">
          <a class="card card-number  pt-5 py-lg-5  rounded  align-items-center" href="#">
            <h1 class="text-center">50</h1>
            <span class="nav-text font-size-lg pb-2  text-center">Clubs <br/>enregistrés</span>
          </a>
        </div>
        <!--begin::Nav Tabs-->
      </div>
      <div class="row pt-5">
        <div class="col mb-4 mb-lg-0">
          <a class="card card-number  pt-5 py-lg-5  rounded  align-items-center" href="#">
            <h1 class="text-center">300</h1>
            <span class="nav-text font-size-lg pb-2  text-center">Joueurs<br/>enregistrés</span>
          </a>
        </div>
        <div class="col mb-4 mb-lg-0">
          <a class="card card-number  pt-5 py-lg-5  rounded  align-items-center" href="#">
            <h1 class="text-center">50</h1>
            <span class="nav-text font-size-lg pb-2  text-center">Tickets <br/>vendus </span>
          </a>
        </div>
        <!--begin::Nav Tabs-->
      </div>
      <div class="row pt-5">
        <div class="col mb-4 mb-lg-0">
          <a href='/dashboard' class="btn  px-6 py-3 btn-red">
            <b-col>
